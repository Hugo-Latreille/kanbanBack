...
const card = {
  ...
  makeCardInDOM(newName, listId, colorData, dataId, newCardPosition, tagsFromCard) {
    ...
    const thisCardId = thisCard.dataset.cardId; // thisCard.addEventListener("dragstart", (e) => {
...
exports.handleListDragFromSortable = exports.handleCardDragFromSortable = exports.default = void 0;
...
const createDropZone = () => {
  ...
  const dropZone = range.createContextualFragment(`<div class="dropZone"></div>`).children[0]; // dropZone.addEventListener("dragover", (e) => {
  // 	e.preventDefault();
...
const handleCardDragFromSortable = e => {
...
exports.handleCardDragFromSortable = handleCardDragFromSortable;

const handleListDragFromSortable = async e => {
...
exports.handleListDragFromSortable = handleListDragFromSortable;

const updateListAndCardsPositionSimpler = async (newListId, oldListId, cardId) => {
  ...
  const newList = document.querySelector(`[data-list-id="${newListId}"]`);
  const allCardsInNewList = newList.querySelectorAll(".box"); // const thisCard = document.querySelector(`[data-card-id="${cardId}"]`);
...
var _dragOther = require("./dragOther.js");
...
const index = {
  ...
  async dragListsWithSortable() {
    ...
    new Sortable(listsContainer, {
      filter: ".list-btn",
      onEnd: _dragOther.handleListDragFromSortable
    });
  }
...
},{"./card.js":1,"./dragOther.js":2,"./list.js":4,"./tags.js":5}],4:[function(require,module,exports){
"use strict";
...
var _dragOther = _interopRequireWildcard(require("./dragOther.js"));
...
const list = {
  ...
  makeListInDOM(listName, listId) {
    ...
    clone.querySelector(".column").dataset.listId = listId; //?sortable

    const cardContainer = clone.querySelector(".panel-block");
    new Sortable(cardContainer, {
      group: "cards",
      onEnd: _dragOther.handleCardDragFromSortable
    });
